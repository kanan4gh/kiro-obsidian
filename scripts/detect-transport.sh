  ...
  cat <<JSON
{
  ...
  "available": {
    ...
    "filesystem": {
      "present": true,
      "vault_root": "${VAULT_ROOT}",
      "note": "ultimate fallback; uses Kiro's Read/Write/Edit tools directly"
    },
    "mcp_obsidian": {
      "present": null,
      "detection": "deferred",
      "note": "MCP servers are not auto-detected. Configure manually if needed."
    },
    "mcpvault": {
      "present": null,
      "detection": "deferred",
...
log "  MCP:        not auto-detected (configure manually if needed)"
