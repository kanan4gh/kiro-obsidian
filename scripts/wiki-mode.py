...
new content of type X be filed under mode Y." Consumed by:
  ...
  - .kiro/steering/skill-wiki-ingest.md  (where to file new source/entity/concept pages)
  - .kiro/steering/skill-save.md         (where to file session notes)
  - .kiro/steering/skill-autoresearch.md (where to file research output)
